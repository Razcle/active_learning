...
def main(opt):
    ...
    init_train_data=train_data_tensor[0:100].to(opt['device'])
    init_train_label=train_label_tensor[0:100].to(opt['device'])
    ...
    for epoch in range(0,1):
        ...
        for i in range(0,1):
            print('iterations',i)
            active_batch_data=train_data_tensor[95:105].to(opt['device'])
